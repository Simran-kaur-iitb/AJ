...
!-------------------------------------------------------!
 subroutine setup_parameters
   ...
   A0=-3367.6*4.55d-6*(1.d0/1.889d0)**2
   B0=133501.2*4.55d-6*(1.d0/1.889d0)**4
   mass=20*1822.d0
   omega_1=200*4.55d-6
   omega_2=287*4.55d-6
   k_1=1.5d-4*4.55d-6*(1.d0/1.889d0)**2
   k_2=-5.d-4*4.55d-6*(1.d0/1.889d0)**3
   k_3=-7.d-3*4.55d-6*(1.d0/1.889d0)**2
 end subroutine
!-------------------------------------------------------!
 subroutine main
   implicit none
   ...
   do i=1,31
     ...
     call diag(mat,n,eigen_value,eigen_vect,m_values)
       write(24,*) x1*0.529, eigen_value(1)*con!, eigen_value(2)*con,eigen_value(3)*con,eigen_value(4)*con,eigen_value(5)*con
  enddo
       write(24,*)
...
!-------------------------------------------------------!
 subroutine initial_conditions
   ...
   m_values=n
   nold=0
   pot=0.d0                     !!-----initializing kinetic and potential energy matrices-----!!
   kin_en=0.d0
   delta_x=(2.d0-(-2.d0))/32.d0 !!---- grid spacing,delta_x= b-a/N,N=grid points+1----!!
 end subroutine
!-------------------------------------------------------!
